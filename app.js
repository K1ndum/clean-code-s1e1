...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add('task-list__wrapper');
    //input (checkbox)
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task-list__wrapper_edit-mode");
    ...
    listItem.classList.toggle("task-list__wrapper_edit-mode");
};
